...
// 지자체 보도자료 단신. "인천시는", "전남광주시," 처럼 **제목 첫머리가 지자체 이름**인 것만
// 잡는다. 문장 아무 데나 걸면 "출범 후에도" 같은 평범한 말까지 딸려 온다.
const LOCAL_STORY = /^[가-힣]{2,6}(?:시|군|구|도|시청|군청|도청)\s*[,·]|^[가-힣]{2,6}(?:시|군|구|도)(?:는|은|이|가)\s/;
